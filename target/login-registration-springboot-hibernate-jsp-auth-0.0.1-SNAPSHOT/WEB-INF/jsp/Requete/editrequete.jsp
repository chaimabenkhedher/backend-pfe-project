            ...
            <div class="row">
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="x_content">
        <c:url var ="action" value ="/updatee"> </c:url>
          <form:form modelAttribute="requete" class="form-horizontal form-label-left" method="post"  action="${action}" >



                      <form:hidden path="id" id="id"  class="form-control" name="id"   required="required" />
              <form:hidden path="code_requete" id="code_requete"  class="form-control" name="code_requete"   required="required" />
                    ...
                    <form:input path="id_databasee" id="id_databasee" readonly="true"  class="form-control" name="id_databasee"  disabled="true"  required="required" type="text"/>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-md-6 col-sm-6 ">
                      <form:input path="kpi" id="kpi"  class="form-control" name="kpi"   readonly="true" disabled="true" type="text" />
                      <form:hidden path="kpi"></form:hidden>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <form:input path="date" id="date" class="form-control" name="date"  required="required" type="text"/>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-3 col-sm-12">
                              ...
                              <form:input path="val_kpi" id="valKPI" class="form-control"  name="valKPI" required="required" type="text"/>
                          
                            </div>As
                            <div class="col-md-3 col-sm-12">
                             
                              <form:input path="val_kpi_alias" id="val_kpi_alias" class="form-control"  name="valKPIAs"  required="required" type="text"/>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <form:textarea path="copr" id="copr" name="copr" col="40" rows="4" oninput="updateTextareaHeight(this);"  required="required"  ></form:textarea>
                           ...
                           <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Dimension <span class="required">*</span>
                            </label>
                          ...
                          <input class="form-control" type="text" value="${d.val_dim_alias}" id="ajoutt" name="ajoutt" size="15"/>
                           ...
                           <input class="form-control" value="${d.id_dim}" type="text" id="ids" name="ids" size="15" hidden="hidden"/>
