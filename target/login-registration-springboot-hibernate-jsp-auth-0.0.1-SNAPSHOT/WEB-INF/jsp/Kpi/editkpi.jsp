    ...
    <div class="container body">
      <div class="main_container">
        ...
        <c:url var ="action" value ="/update"> </c:url>
          <form:form modelAttribute="kpi" class="form-horizontal form-label-left" method="post"  action="${action}" >
                 ...
                 <form:radiobutton   path="type" NAME="type"   value="Father"    />
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <form:input  path="id_kpi" type="number" id="id_kpi" name="id_kpi" required="required" class="form-control"/>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <form:input  path="name_kpi" type="text" placeholder="Code_requete" id="name_kpi"  name="name_kpi" required="required" class="form-control"  />
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                              ...
                              <form:input path="subject_area" id="subject_area" name="subject_area" class="form-control" required="required" type="text"/>
                          
                            </div>
                          </div>
                          <div class="form-group row">
                            <label class="col-form-label col-md-3 col-sm-3 label-align">Seuil arrondissement dimension <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 ">
                        
                              <form:input path="seuil" id="seuil"  class="form-control" name="seuil" required="required" type="number" step="0.01" min="0" />
                       
                            </div>
                          </div>
              <div class="form-group row">
                  <label class="col-form-label col-md-3 col-sm-3 label-align">Seuil gap <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 ">

                      <form:input path="seuil_gap" id="seuil_gap"  class="form-control" name="seuil_gap" required="required" type="number" step="0.01" min="0" />

                  </div>
              </div>
              <div class="form-group row">
                  <label class="col-form-label col-md-3 col-sm-3 label-align">Seuil dataQuality <span class="required">*</span>
                  </label>
                  <div class="col-md-6 col-sm-6 ">

                      <form:input path="seuil_dataQuality" id="seuil_dataQuality"  class="form-control" name="seuil_dataQuality" required="required" type="number" step="0.01" min="0" />
